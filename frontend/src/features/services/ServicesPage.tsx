    ...
    <TenantShell>
      ...
      >
        <input
          ...
          className="flex-1 rounded-md border border-slate-300 bg-transparent px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:border-slate-600"
        />
        <button
          type="submit"
