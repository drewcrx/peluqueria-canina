      ...
      <Modal open={schedulingId !== null} onClose={() => setSchedulingId(null)} title="Confirmar fecha de la cita">
        <div className="space-y-3">
          <input
            ...
            className="w-full rounded-md border border-slate-300 bg-transparent px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:border-slate-600"
          />
          <button
